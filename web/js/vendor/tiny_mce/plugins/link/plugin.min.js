...
tinymce.PluginManager.add('link', function(editor) {
	...
	function showDialog(linkList) {
		...
		function buildTargetList(targetValue) {
			var targetListItems = [{text: 'New tab', value: '_blank'}];

			if (!editor.settings.target_list) {
				targetListItems.push({text: 'Same tab', value: '_self'});
			}
		...
		win = editor.windowManager.open({
            ...
            } , {name: 'text', type: 'textbox', classes: 'text_' + editor.id, size: 40, label: 'Text to display', onchange: function() {
